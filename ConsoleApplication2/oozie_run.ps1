...
$clusterName = "crmhbasecluster2"
$clusterUsername = "admin"
$clusterPassword = "Turtledive11)"

#Azure Blob storage (WASB) variables
$storageAccountName = "crmhbasestorage"
$storageContainerName = "crmhbasecluster2"
$storageUri="wasb://$storageContainerName@$storageAccountName.blob.core.windows.net"

# Following variables CAN be passed in with payload ($OoziePayload) to be used in coordinator.xml and
# workflow.xml, but these values are currently hardcoded into their
# respective locations, so passing them in right now does nothing
